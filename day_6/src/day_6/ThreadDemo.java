 ...
 *  : " display the value of the counter ranging from 1 to 10. Within the loop put the thread to sleep for 
 *  2 seconds. In main create 3 objects of the DemoTread1 and execute the program.
 */
